...
namespace opengl {
	...
	public:
		...
		static m64p_error CoreVideo_SetVideoMode(int screenWidth, int screenHeight, int screenRefresh, int bitsPerPixel, m64p_video_mode mode, m64p_video_flags flags);
